...
public class CrawlTaoBao {
    ...
    class Processor implements PageProcessor{
        private List<Map<String,Object>> crawlData = null;
        Processor(List<Map<String,Object>> crawlData) {
    ...
    public List<Map<String,Object>> crawlTaoBao(String shopCrawlUrl) throws Exception{
        int i = 1;
        List<Map<String,Object>> list = new ArrayList<Map<String, Object>>();
        isStop = false;
        shopCrawlUrl = shopCrawlUrl+"&pageNo=";
        while (true){
            if(isStop){
                break;
            }
